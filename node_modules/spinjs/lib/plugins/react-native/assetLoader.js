...
var utils = requireModule_1.default('loader-utils');
var size = requireModule_1.default('image-size');
var hasha = requireModule_1.default('hasha');
var hashAssetFiles = requireModule_1.default('expo/tools/hashAssetFiles');
var AssetResolver = requireModule_1.default('haul/src/resolvers/AssetResolver');
module.exports = function assetLoader() {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        var callback, query, options, config, info, filepath, dirname, url, type, assets, suffix, filename, longname, result, map, scales, pairs, publicPath, hashes, asset, finalAsset, assetStr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    this.cacheable();
                    callback = this.async();
                    query = utils.getOptions(this) || {};
                    options = this.options[query.config] || {};
                    ...
                    url = path.relative(config.root, dirname);
                ...
                case 2:
                    ...
                    publicPath = "__webpack_public_path__ + " + JSON.stringify(path.join('/', assets, url));
